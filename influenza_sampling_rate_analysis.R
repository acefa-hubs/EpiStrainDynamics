...
# SR100
rw_influenza_data1_SR100 <- list(
  num_data = nrow(df1_SR100),
  num_path = 4,
  Y = df1_SR100$ili,
  P1 = t(matrix(
    data = c(
      df1_SR100$inf_A,
      df1_SR100$inf_B,
      df1_SR100$num_spec - df1_SR100$inf_all
    ),
    ncol = 3
  )),
  P2 = t(matrix(
    data = c(df1_SR100$inf_H3N2, df1_SR100$inf_H1N1),
    ncol = 2
  )),
  week_effect = 1,
  DOW = (df1$time %% 1) + 1,
...
rw_influenza_fit1_SR100 <- sampling(
  rw_influenza_mod,
  iter = 5000,
  warmup = 1000,
  chains = 4,
...
saveRDS(rw_influenza_fit1_SR100,
        "FitStanModels/rw_influenza_fit1_SR100.rds")

# SR50
rw_influenza_data1_SR50 <- list(
  num_data = nrow(df1_SR50),
  num_path = 4,
  Y = df1_SR50$ili,
  P1 = t(matrix(
    data = c(
      df1_SR50$inf_A,
      df1_SR50$inf_B,
      df1_SR50$num_spec - df1_SR50$inf_all
    ),
    ncol = 3
  )),
  P2 = t(matrix(
    data = c(df1_SR50$inf_H3N2, df1_SR50$inf_H1N1),
    ncol = 2
  )),
  week_effect = 1,
  DOW = (df1$time %% 1) + 1,
...
rw_influenza_fit1_SR50 <- sampling(
  rw_influenza_mod,
  iter = 5000,
  warmup = 1000,
  chains = 4,
...
saveRDS(rw_influenza_fit1_SR50,
        "FitStanModels/rw_influenza_fit1_SR50.rds")

# SR20
rw_influenza_data1_SR20 <- list(
  num_data = nrow(df1_SR20),
  num_path = 4,
  Y = df1_SR20$ili,
  P1 = t(matrix(
    data = c(
      df1_SR20$inf_A,
      df1_SR20$inf_B,
      df1_SR20$num_spec - df1_SR20$inf_all
    ),
    ncol = 3
  )),
  P2 = t(matrix(
    data = c(df1_SR20$inf_H3N2, df1_SR20$inf_H1N1),
    ncol = 2
  )),
  week_effect = 1,
  DOW = (df1$time %% 1) + 1,
...
rw_influenza_fit1_SR20 <- sampling(
  rw_influenza_mod,
  iter = 5000,
  warmup = 1000,
  chains = 4,
...
saveRDS(rw_influenza_fit1_SR20,
        "FitStanModels/rw_influenza_fit1_SR20.rds")

###############################################################################
## Models fit to United States of America
# SR100
rw_influenza_data2_SR100 <- list(
  num_data = nrow(df2_SR100),
  num_path = 4,
  Y = df2_SR100$ili,
  P1 = t(matrix(
    data = c(
      df2_SR100$inf_A,
      df2_SR100$inf_B,
      df2_SR100$num_spec - df2_SR100$inf_all
    ),
    ncol = 3
  )),
  P2 = t(matrix(
    data = c(df2_SR100$inf_H3N2, df2_SR100$inf_H1N1),
    ncol = 2
  )),
  week_effect = 1,
...
rw_influenza_fit2_SR100 <- sampling(
  rw_influenza_mod,
  iter = 5000,
  warmup = 1000,
  chains = 4,
...
saveRDS(rw_influenza_fit2_SR100,
        "FitStanModels/rw_influenza_fit2_SR100.rds")

# SR50
rw_influenza_data2_SR50 <- list(
  num_data = nrow(df2_SR50),
  num_path = 4,
  Y = df2_SR50$ili,
  P1 = t(matrix(
    data = c(
      df2_SR50$inf_A,
      df2_SR50$inf_B,
      df2_SR50$num_spec - df2_SR50$inf_all
    ),
    ncol = 3
  )),
  P2 = t(matrix(
    data = c(df2_SR50$inf_H3N2, df2_SR50$inf_H1N1),
    ncol = 2
  )),
  week_effect = 1,
...
rw_influenza_fit2_SR50 <- sampling(
  rw_influenza_mod,
  iter = 5000,
  warmup = 1000,
  chains = 4,
...
saveRDS(rw_influenza_fit2_SR50,
        "FitStanModels/rw_influenza_fit2_SR50.rds")

# SR20
rw_influenza_data2_SR20 <- list(
  num_data = nrow(df2_SR20),
  num_path = 4,
  Y = df2_SR20$ili,
  P1 = t(matrix(
    data = c(
      df2_SR20$inf_A,
      df2_SR20$inf_B,
      df2_SR20$num_spec - df2_SR20$inf_all
    ),
    ncol = 3
  )),
  P2 = t(matrix(
    data = c(df2_SR20$inf_H3N2, df2_SR20$inf_H1N1),
    ncol = 2
  )),
  week_effect = 1,
...
rw_influenza_fit2_SR20 <- sampling(
  rw_influenza_mod,
  iter = 5000,
  warmup = 1000,
  chains = 4,
...
saveRDS(rw_influenza_fit2_SR20,
        "FitStanModels/rw_influenza_fit2_SR20.rds")

###############################################################################
## Model fit to Singapore
#SR100
rw_influenza_data3_SR100 <- list(
  num_data = nrow(df3_SR100),
  num_path = 4,
  Y = df3_SR100$ili,
  P1 = t(matrix(
    data = c(
      df3_SR100$inf_A,
      df3_SR100$inf_B,
      df3_SR100$num_spec - df3_SR100$inf_all
    ),
    ncol = 3
  )),
  P2 = t(matrix(
    data = c(df3_SR100$inf_H3N2, df3_SR100$inf_H1N1),
    ncol = 2
  )),
  week_effect = 1,
...
rw_influenza_fit3_SR100 <- sampling(
  rw_influenza_mod,
  iter = 5000,
  warmup = 1000,
  chains = 4,
...
saveRDS(rw_influenza_fit3_SR100,
        "FitStanModels/rw_influenza_fit3_SR100.rds")

#SR50
rw_influenza_data3_SR50 <- list(
  num_data = nrow(df3_SR50),
  num_path = 4,
  Y = df3_SR50$ili,
  P1 = t(matrix(
    data = c(
      df3_SR50$inf_A,
      df3_SR50$inf_B,
      df3_SR50$num_spec - df3_SR50$inf_all
    ),
    ncol = 3
  )),
  P2 = t(matrix(
    data = c(df3_SR50$inf_H3N2, df3_SR50$inf_H1N1),
    ncol = 2
  )),
  week_effect = 1,
...
rw_influenza_fit3_SR50 <- sampling(
  rw_influenza_mod,
  iter = 5000,
  warmup = 1000,
  chains = 4,
...
saveRDS(rw_influenza_fit3_SR50,
        "FitStanModels/rw_influenza_fit3_SR50.rds")

#SR20
rw_influenza_data3_SR20 <- list(
  num_data = nrow(df3_SR20),
  num_path = 4,
  Y = df3_SR20$ili,
  P1 = t(matrix(
    data = c(
      df3_SR20$inf_A,
      df3_SR20$inf_B,
      df3_SR20$num_spec - df3_SR20$inf_all
    ),
    ncol = 3
  )),
  P2 = t(matrix(
    data = c(df3_SR20$inf_H3N2, df3_SR20$inf_H1N1),
    ncol = 2
  )),
  week_effect = 1,
...
rw_influenza_fit3_SR20 <- sampling(
  rw_influenza_mod,
  iter = 5000,
  warmup = 1000,
  chains = 4,
...
saveRDS(rw_influenza_fit3_SR20,
        "FitStanModels/rw_influenza_fit3_SR20.rds")
...
rw_mod_inc1_SR20 <- rw_incidence(rw_influenza_fit1_SR20,
                                 num_days = nrow(df1),
                                 time_labels = df1$week)
rw_mod_inc1_SR50 <- rw_incidence(rw_influenza_fit1_SR50,
                                 num_days = nrow(df1),
                                 time_labels = df1$week)
rw_mod_inc1_SR100 <- rw_incidence(rw_influenza_fit1_SR100,
                                  num_days = nrow(df1),
                                  time_labels = df1$week)
rw_mod_inc1_SRX <- rw_incidence(rw_influenza_fit1_SRX,
                                num_days = nrow(df1),
                                time_labels = df1$week)
...
rw_mod_inc1$sampling <- factor(
  rw_mod_inc1$sampling,
  levels = c("20/week max", "50/week max", "100/week max", "Original")
)
...
plt1 <- ggplot(rw_mod_inc1[rw_mod_inc1$pathogen == "Total", ]) +
  ...
  #geom_ribbon(aes(x=time, y=y, ymin=lb_50, ymax=ub_50,
  #fill=sampling), alpha=0.2)+
  geom_ribbon(aes(
    x = time,
    y = y,
    ymin = lb_95,
  ...
  theme_bw() +
  geom_label(aes(
    label = "Total influenza-like illness",
...
plt2i <- plt2 +
  coord_cartesian(xlim = c(as.Date("2016-04-01"),
                           as.Date("2017-01-01")),
                  ylim = c(0, 125)) +
  theme(
...
plt3i <- plt3 +
  coord_cartesian(xlim = c(as.Date("2016-01-01"),
                           as.Date("2017-01-01")),
                  ylim = c(0, 15)) +
  theme(
    axis.title = element_blank(),
...
patch2 <- plt2i + plt3i + plt4i + plot_layout(nrow = 3)
...
ggsave("Figures/Influenza_SR_Aus.png",
       width = 10,
       height = 14)
...
rw_mod_inc2_SR20 <- rw_incidence(rw_influenza_fit2_SR20,
                                 num_days = nrow(df2),
                                 time_labels = df2$week)
rw_mod_inc2_SR50 <- rw_incidence(rw_influenza_fit2_SR50,
                                 num_days = nrow(df2),
                                 time_labels = df2$week)
rw_mod_inc2_SR100 <- rw_incidence(rw_influenza_fit2_SR100,
                                  num_days = nrow(df2),
                                  time_labels = df2$week)
rw_mod_inc2_SRX <- rw_incidence(rw_influenza_fit2_SRX,
                                num_days = nrow(df2),
                                time_labels = df2$week)
...
rw_mod_inc2$sampling <- factor(
  rw_mod_inc2$sampling,
  levels = c("20/week max", "50/week max", "100/week max", "Original")
)
...
plt2i <- plt2 + coord_cartesian(xlim = c(as.Date("2018-11-01"),
                                         as.Date("2019-06-01")),
                                ylim = c(0, 17000)) +
  theme(
    axis.title = element_blank(),
...
plt3i <- plt3 + coord_cartesian(xlim = c(as.Date("2018-11-01"),
                                         as.Date("2019-05-01")),
                                ylim = c(0, 32000)) +
  theme(
    axis.title = element_blank(),
...
plt4i <- plt4 + coord_cartesian(xlim = c(as.Date("2018-07-01"),
                                         as.Date("2019-07-01")),
                                ylim = c(0, 2000)) +
  theme(
    axis.title = element_blank(),
...
ggsave("Figures/Influenza_SR_USA.png",
       width = 10,
       height = 14)
...
rw_mod_inc3_SR20 <- rw_incidence(rw_influenza_fit3_SR20,
                                 num_days = nrow(df3),
                                 time_labels = df3$week)
rw_mod_inc3_SR50 <- rw_incidence(rw_influenza_fit3_SR50,
                                 num_days = nrow(df3),
                                 time_labels = df3$week)
rw_mod_inc3_SR100 <- rw_incidence(rw_influenza_fit3_SR100,
                                  num_days = nrow(df3),
                                  time_labels = df3$week)
rw_mod_inc3_SRX <- rw_incidence(rw_influenza_fit3_SRX,
                                num_days = nrow(df3),
                                time_labels = df3$week)
...
rw_mod_inc3$sampling <- factor(
  rw_mod_inc3$sampling,
  levels = c("20/week max", "50/week max", "100/week max", "Original")
)
...
plt2i <- plt2 +
  coord_cartesian(xlim = c(as.Date("2017-07-01"),
                           as.Date("2018-07-01")),
                  ylim = c(0, 100)) +
  theme(
    axis.title = element_blank(),
...
ggsave("Figures/Influenza_SR_SIN.png",
       width = 10,
       height = 14)
...
df_new1$sampling <- factor(
  df_new1$sampling,
  levels = c(
    "Original testing rate",
    "100 tests/week max",
    "50 tests/week max",
    "20 tests/week max"
  )
...
ggsave("Figures/InfluenzaRaw1.png",
       width = 10,
       height = 12)
...
ggsave("Figures/InfluenzaRaw2.png",
       width = 10,
       height = 12)
...
ggsave("Figures/InfluenzaRaw3.png",
       width = 10,
       height = 12)
