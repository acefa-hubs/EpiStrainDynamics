...
- [`construct_model()`](https://acefa-hubs.github.io/EpiStrainDynamics/reference/construct_model.md)
  : Construct model
- [`print(`*`<EpiStrainDynamics.model>`*`)`](https://acefa-hubs.github.io/EpiStrainDynamics/reference/print.EpiStrainDynamics.model.md)
...
- [`plot(`*`<incidence>`*`)`](https://acefa-hubs.github.io/EpiStrainDynamics/reference/plot.md)
  [`plot(`*`<growth_rate>`*`)`](https://acefa-hubs.github.io/EpiStrainDynamics/reference/plot.md)
  [`plot(`*`<Rt>`*`)`](https://acefa-hubs.github.io/EpiStrainDynamics/reference/plot.md)
  [`plot(`*`<proportion>`*`)`](https://acefa-hubs.github.io/EpiStrainDynamics/reference/plot.md)
