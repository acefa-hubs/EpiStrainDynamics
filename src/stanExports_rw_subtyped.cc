...
#include "stanExports_rw_subtyped.h"

RCPP_MODULE(stan_fit4rw_subtyped_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_rw_subtyped")
