...
namespace model_rw_mp_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 54> locations_array__ =
  {" (found before start of program)",
  " (in 'rw_mp', line 22, column 2 to column 31)",
  " (in 'rw_mp', line 23, column 2 to column 40)",
  " (in 'rw_mp', line 25, column 2 to column 20)",
  " (in 'rw_mp', line 26, column 2 to column 20)",
  " (in 'rw_mp', line 28, column 2 to column 43)",
  " (in 'rw_mp', line 30, column 2 to column 74)",
  " (in 'rw_mp', line 31, column 2 to column 50)",
  " (in 'rw_mp', line 48, column 6 to column 84)",
  " (in 'rw_mp', line 47, column 4 to line 48, column 84)",
  " (in 'rw_mp', line 46, column 6 to line 49, column 3)",
  " (in 'rw_mp', line 43, column 6 to column 84)",
  " (in 'rw_mp', line 42, column 4 to line 43, column 84)",
  " (in 'rw_mp', line 41, column 27 to line 44, column 3)",
  " (in 'rw_mp', line 41, column 7 to line 49, column 3)",
  " (in 'rw_mp', line 38, column 6 to column 59)",
  " (in 'rw_mp', line 37, column 4 to line 38, column 59)",
  " (in 'rw_mp', line 36, column 22 to line 39, column 3)",
  " (in 'rw_mp', line 36, column 2 to line 49, column 3)",
  " (in 'rw_mp', line 56, column 6 to column 41)",
  " (in 'rw_mp', line 55, column 22 to line 57, column 3)",
  " (in 'rw_mp', line 55, column 2 to line 57, column 3)",
  " (in 'rw_mp', line 61, column 2 to column 15)",
  " (in 'rw_mp', line 72, column 6 to column 27)",
  " (in 'rw_mp', line 73, column 6 to column 84)",
  " (in 'rw_mp', line 74, column 6 to column 41)",
  " (in 'rw_mp', line 71, column 24 to line 75, column 7)",
  " (in 'rw_mp', line 71, column 4 to line 75, column 7)",
  " (in 'rw_mp', line 70, column 6 to line 76, column 3)",
  " (in 'rw_mp', line 65, column 6 to column 27)",
  " (in 'rw_mp', line 66, column 6 to column 44)",
  " (in 'rw_mp', line 67, column 6 to column 41)",
  " (in 'rw_mp', line 64, column 24 to line 68, column 7)",
  " (in 'rw_mp', line 64, column 4 to line 68, column 7)",
  " (in 'rw_mp', line 63, column 20 to line 69, column 3)",
  " (in 'rw_mp', line 63, column 2 to line 76, column 3)",
  " (in 'rw_mp', line 13, column 2 to column 15)",
  " (in 'rw_mp', line 14, column 2 to column 15)",
  " (in 'rw_mp', line 15, column 8 to column 16)",
  " (in 'rw_mp', line 15, column 2 to column 18)",
  " (in 'rw_mp', line 16, column 8 to column 16)",
  " (in 'rw_mp', line 16, column 18 to column 26)",
  " (in 'rw_mp', line 16, column 2 to column 28)",
  " (in 'rw_mp', line 17, column 2 to column 18)",
  " (in 'rw_mp', line 18, column 10 to column 18)",
  " (in 'rw_mp', line 18, column 2 to column 20)",
  " (in 'rw_mp', line 19, column 2 to column 42)",
  " (in 'rw_mp', line 22, column 9 to column 17)",
  " (in 'rw_mp', line 22, column 19 to column 27)",
  " (in 'rw_mp', line 23, column 18 to column 26)",
  " (in 'rw_mp', line 23, column 28 to column 36)",
  " (in 'rw_mp', line 28, column 10 to column 21)",
  " (in 'rw_mp', line 30, column 20 to column 71)",
  " (in 'rw_mp', line 31, column 13 to column 42)"};
#include <stan_meta_header.hpp>
class model_rw_mp final : public model_base_crtp<model_rw_mp> {
private:
  int num_data;
  int num_path;
  std::vector<int> Y;
...
public:
  ~model_rw_mp() {}
  model_rw_mp(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_rw_mp_namespace::model_rw_mp";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = (num_path * num_data) + (num_path * num_data) + 1 + 1 +
      (week_effect - 1) + tau_1dim__ + (Sigma_1dim__ + ((Sigma_1dim__ *
      (Sigma_1dim__ - 1)) / 2));
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_rw_mp_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_rw_mp_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"a", "c", "phi", "eta",
                "day_of_week_simplex", "tau", "Sigma"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"a\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(num_path) + ",\"cols\":" + std::to_string(num_data) + "},\"block\":\"parameters\"},{\"name\":\"c\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(num_path) + ",\"cols\":" + std::to_string(num_data) + "},\"block\":\"parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"eta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"day_of_week_simplex\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(week_effect) + "},\"block\":\"parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(tau_1dim__) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"Sigma\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(Sigma_1dim__) + ",\"cols\":" + std::to_string(Sigma_2dim__) + "},\"block\":\"parameters\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"a\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(num_path) + ",\"cols\":" + std::to_string(num_data) + "},\"block\":\"parameters\"},{\"name\":\"c\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(num_path) + ",\"cols\":" + std::to_string(num_data) + "},\"block\":\"parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"eta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"day_of_week_simplex\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string((week_effect -1)) + "},\"block\":\"parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(tau_1dim__) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"Sigma\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string((Sigma_1dim__ + ((Sigma_1dim__ * (Sigma_1dim__ - 1)) /2))) + "},\"block\":\"parameters\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((((((num_path * num_data) + (num_path *
      num_data)) + 1) + 1) + week_effect) + tau_1dim__) + (Sigma_1dim__ *
      Sigma_2dim__));
...
using stan_model = model_rw_mp_namespace::model_rw_mp;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_rw_mp_namespace::profiles__;
}
#endif
#endif
