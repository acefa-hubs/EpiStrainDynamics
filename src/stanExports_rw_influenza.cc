...
#include "stanExports_rw_influenza.h"

RCPP_MODULE(stan_fit4rw_influenza_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_rw_influenza")
