...
#include "stanExports_rw_multiple.h"

RCPP_MODULE(stan_fit4rw_multiple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_rw_multiple")
