...
#include "stanExports_ps_subtyped.h"

RCPP_MODULE(stan_fit4ps_subtyped_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_ps_subtyped")
