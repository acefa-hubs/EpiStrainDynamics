...
namespace model_ps_multiple_namespace {
...
static constexpr std::array<const char*, 113> locations_array__ =
  ...
  " (in 'ps_multiple', line 46, column 9 to column 18)",
  " (in 'ps_multiple', line 46, column 2 to column 26)",
  " (in 'ps_multiple', line 47, column 2 to column 20)",
  " (in 'ps_multiple', line 48, column 8 to column 16)",
  " (in 'ps_multiple', line 48, column 2 to column 18)",
  " (in 'ps_multiple', line 49, column 8 to column 16)",
  " (in 'ps_multiple', line 49, column 18 to column 26)",
  " (in 'ps_multiple', line 49, column 2 to column 28)",
  " (in 'ps_multiple', line 50, column 9 to column 17)",
  " (in 'ps_multiple', line 50, column 2 to column 19)",
  " (in 'ps_multiple', line 51, column 2 to column 18)",
  " (in 'ps_multiple', line 52, column 10 to column 18)",
  ...
  " (in 'ps_multiple', line 23, column 4 to column 48)",
  " (in 'ps_multiple', line 24, column 11 to column 18)",
  " (in 'ps_multiple', line 24, column 4 to column 48)",
  " (in 'ps_multiple', line 30, column 8 to line 31, column 52)",
  " (in 'ps_multiple', line 29, column 6 to line 31, column 52)",
  " (in 'ps_multiple', line 33, column 8 to line 34, column 52)",
  " (in 'ps_multiple', line 32, column 6 to line 34, column 52)",
  " (in 'ps_multiple', line 36, column 6 to line 37, column 59)",
  " (in 'ps_multiple', line 28, column 9 to line 38, column 5)",
  " (in 'ps_multiple', line 27, column 4 to column 72)",
  " (in 'ps_multiple', line 26, column 6 to line 27, column 72)",
  " (in 'ps_multiple', line 25, column 4 to line 38, column 5)",
  " (in 'ps_multiple', line 39, column 4 to column 20)",
  " (in 'ps_multiple', line 16, column 72 to line 40, column 3)"};
...
class model_ps_multiple final : public model_base_crtp<model_ps_multiple> {
private:
  int num_data;
  int num_knots;
  int num_path;
...
public:
  ~model_ps_multiple() {}
  model_ps_multiple(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_ps_multiple_namespace::model_ps_multiple";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_ps_multiple_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
            ...
            lp_accum__.add(stan::math::multinomial_lpmf<propto__>(
                             ...
                             stan::math::divide(
                               stan::model::rvalue(c_new, "c_new",
                                 stan::model::index_omni(),
                                 stan::model::index_uni(i)),
                               stan::model::rvalue(y_model, "y_model",
                                 stan::model::index_uni(i)))));
          }
        } else {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_ps_multiple_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_ps_multiple_namespace::model_ps_multiple;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_ps_multiple_namespace::profiles__;
}
#endif
#endif
