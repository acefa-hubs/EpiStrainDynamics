...
rw_influenza_fit1 <- sampling(rw_influenza_mod,
                              iter= 5000,
                              warmup = 1000,
                              chains=4,
...
rw_influenza_data1_N1 <- list(num_data = nrow(df1),
                           num_path = 4,
                           Y = df1$ili,
                           P1 = t(matrix(data= c(df1$inf_A, df1$inf_B, df1$num_spec-df1$inf_all), ncol=3) ),
                           P2 = t(matrix(data= c(df1$inf_H3N2, df1$inf_H1N1), ncol=2) ),
...
rw_influenza_fit1_N1 <- sampling(rw_influenza_mod,
                              iter= 5000,
                              warmup = 1000,
                              chains=4,
                              data = rw_influenza_data1_N1)

saveRDS(rw_influenza_fit1_N1, "FitStanModels/rw_influenza_fit1_N1.rds")

#############################################################################################################################################
## Model fit to United States of America (for main analysis)
rw_influenza_data2 <- list(num_data = nrow(df2),
                           num_path = 4,
                           Y = df2$ili,
                           P1 = t(matrix(data= c(df2$inf_A, df2$inf_B, df2$num_spec-df2$inf_all), ncol=3) ),
                           P2 = t(matrix(data= c(df2$inf_H3N2, df2$inf_H1N1), ncol=2) ),
                           week_effect = 1,
                           DOW = (df2$time %% 1)+1,
                           cov_structure = 1,
                           noise_structure = 0)

rw_influenza_fit2 <- sampling(rw_influenza_mod,
                              iter=5000,
                              warmup =1000,
                              chains=4,
...
rw_influenza_data2_N1 <- list(num_data = nrow(df2),
                           num_path = 4,
                           Y = df2$ili,
                           P1 = t(matrix(data= c(df2$inf_A, df2$inf_B, df2$num_spec-df2$inf_all), ncol=3) ),
                           P2 = t(matrix(data= c(df2$inf_H3N2, df2$inf_H1N1), ncol=2) ),
...
rw_influenza_fit2_N1 <- sampling(rw_influenza_mod,
                              iter=5000,
                              warmup =1000,
                              chains=4,
...
rw_influenza_data3 <- list(num_data = nrow(df3),
                           num_path = 4,
                           Y = df3$ili,
                           P1 = t(matrix(data= c(df3$inf_A, df3$inf_B, df3$num_spec-df3$inf_all), ncol=3) ),
                           P2 = t(matrix(data= c(df3$inf_H3N2, df3$inf_H1N1), ncol=2) ),
                           week_effect = 1,
                           DOW = (df3$time %% 1)+1,
                           cov_structure = 1,
                           noise_structure = 0)

rw_influenza_fit3 <- sampling(rw_influenza_mod,
                              iter=5000,
                              warmup =1000,
                              chains=4,
...
rw_influenza_data3_N1 <- list(num_data = nrow(df3),
                           num_path = 4,
                           Y = df3$ili,
                           P1 = t(matrix(data= c(df3$inf_A, df3$inf_B, df3$num_spec-df3$inf_all), ncol=3) ),
                           P2 = t(matrix(data= c(df3$inf_H3N2, df3$inf_H1N1), ncol=2) ),
...
rw_influenza_fit3_N1 <- sampling(rw_influenza_mod,
                              iter=5000,
                              warmup =1000,
                              chains=4,
                              data = rw_influenza_data3_N1)

saveRDS(rw_influenza_fit3_N1, "FitStanModels/rw_influenza_fit3_N1.rds")
...
rw_mod_inc1 <- rw_incidence(rw_influenza_fit1, num_days = nrow(df1), time_labels = df1$week)
rw_mod_inc2 <- rw_incidence(rw_influenza_fit2, num_days = nrow(df2), time_labels = df2$week)
rw_mod_inc3 <- rw_incidence(rw_influenza_fit3, num_days = nrow(df3), time_labels = df3$week)
...
plt1a <- plt1a+
  ...
  geom_label(aes(label = "Australia", x=as.Date("2018-01-01"), y=Inf ), vjust=1.2)
plt1b <- plt1b+
  labs(tag="A")+
  theme(plot.tag.position = c(0.01,0.97),
        axis.title.x = element_blank(),
        axis.text.x = element_blank())+
  geom_label(aes(label = "United States of America", x=as.Date("2018-01-01"), y=Inf ), vjust=1.2)
plt1c <- plt1c+
  labs(tag="B")+
  theme(plot.tag.position = c(0.01,0.97),
        axis.title.x = element_blank(),
  ...
  geom_label(aes(label = "Singapore", x=as.Date("2018-01-01"), y=Inf ), vjust=1.2)



plt1b / plt1c / plt1a

ggsave("Figures/Influenza1.png", width=14, height=10)
...
plt2a <- ggplot(rw_mod_inc1[rw_mod_inc1$pathogen %in% c("Influenza A H3N2", "Influenza A H1N1", "Influenza B"),])+
  geom_line(aes(x=time, y=y, color=pathogen))+
  geom_ribbon(aes(x=time, y=y, ymin=lb_50, ymax=ub_50, fill=pathogen), alpha=0.2)+
  geom_ribbon(aes(x=time, y=y, ymin=lb_95, ymax=ub_95, fill=pathogen), alpha=0.2)+
  coord_cartesian(xlim=c(as.Date("2012-01-01")+180, as.Date("2024-01-01")-180))+
...
plt2b <- ggplot(rw_mod_inc2[rw_mod_inc2$pathogen %in% c("Influenza A H3N2", "Influenza A H1N1", "Influenza B"),])+
  geom_line(aes(x=time, y=y, color=pathogen))+
  geom_ribbon(aes(x=time, y=y, ymin=lb_50, ymax=ub_50, fill=pathogen), alpha=0.2)+
  geom_ribbon(aes(x=time, y=y, ymin=lb_95, ymax=ub_95, fill=pathogen), alpha=0.2)+
  coord_cartesian(xlim=c(as.Date("2012-01-01")+180, as.Date("2024-01-01")-180))+
...
plt2c <- ggplot(rw_mod_inc3[rw_mod_inc3$pathogen %in% c("Influenza A H3N2", "Influenza A H1N1", "Influenza B"),])+
  geom_line(aes(x=time, y=y, color=pathogen))+
  geom_ribbon(aes(x=time, y=y, ymin=lb_50, ymax=ub_50, fill=pathogen), alpha=0.2)+
  geom_ribbon(aes(x=time, y=y, ymin=lb_95, ymax=ub_95, fill=pathogen), alpha=0.2)+
  coord_cartesian(xlim=c(as.Date("2012-01-01")+180, as.Date("2024-01-01")-180))+
...
plt2a<- plt2a+
  annotate("rect", xmin = as.Date("2012-05-01"), xmax = as.Date("2012-10-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2013-05-01"), xmax = as.Date("2013-10-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2014-05-01"), xmax = as.Date("2014-10-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2015-05-01"), xmax = as.Date("2015-10-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2016-05-01"), xmax = as.Date("2016-10-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2017-05-01"), xmax = as.Date("2017-10-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2018-05-01"), xmax = as.Date("2018-10-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2019-05-01"), xmax = as.Date("2019-10-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2020-05-01"), xmax = as.Date("2020-10-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2021-05-01"), xmax = as.Date("2021-10-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2022-05-01"), xmax = as.Date("2022-10-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2023-05-01"), xmax = as.Date("2023-10-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  geom_label(aes(label = "Australia", x=as.Date("2018-01-01"), y=Inf ), vjust=1.2)
  
  
plt2b<- plt2b+
  annotate("rect", xmin = as.Date("2011-11-01"), xmax = as.Date("2012-04-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2012-11-01"), xmax = as.Date("2013-04-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2013-11-01"), xmax = as.Date("2014-04-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2014-11-01"), xmax = as.Date("2015-04-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2015-11-01"), xmax = as.Date("2016-04-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2016-11-01"), xmax = as.Date("2017-04-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2017-11-01"), xmax = as.Date("2018-04-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2018-11-01"), xmax = as.Date("2019-04-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2019-11-01"), xmax = as.Date("2020-04-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2020-11-01"), xmax = as.Date("2021-04-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2021-11-01"), xmax = as.Date("2022-04-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2022-11-01"), xmax = as.Date("2023-04-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  annotate("rect", xmin = as.Date("2023-11-01"), xmax = as.Date("2024-04-30"), ymin = -Inf, ymax = Inf, 
           fill='grey', alpha = 0.2, linetype = "dashed")+
  geom_label(aes(label = "United States of America", x=as.Date("2018-01-01"), y=Inf ), vjust=1.2)
...
ggsave("Figures/Influenza2.png", width=14, height=10)
...
rw_mod_gr1 <- rw_growth_rate(rw_influenza_fit1, num_days = nrow(df1), time_labels = df1$week)
rw_mod_gr2 <- rw_growth_rate(rw_influenza_fit2, num_days = nrow(df2), time_labels = df1$week)
rw_mod_gr3 <- rw_growth_rate(rw_influenza_fit3, num_days = nrow(df3), time_labels = df1$week)
...
rw_mod_gr <- rbind(rw_mod_gr1,
                   rw_mod_gr2,
                   rw_mod_gr3)


# Plot
ggplot(rw_mod_gr[rw_mod_gr$pathogen %in% c("Influenza A H3N2", "Influenza A H1N1", "Influenza B"),])+
  facet_wrap(.~pathogen, nrow = 3)+
  geom_line(aes(x=time, y=y, color=country))+
  geom_ribbon(aes(x=time, y=y, ymin=lb_50, ymax=ub_50, fill=country), alpha=0.2)+
  geom_ribbon(aes(x=time, y=y, ymin=lb_95, ymax=ub_95, fill=country), alpha=0.2)+
...
ggsave("Figures/Influenza3.png", width=14, height=10)
...
rw_mod_inc1_N1 <- rw_incidence(rw_influenza_fit1_N1, num_days = nrow(df1), time_labels = df1$week)
rw_mod_inc2_N1 <- rw_incidence(rw_influenza_fit2_N1, num_days = nrow(df2), time_labels = df2$week)
rw_mod_inc3_N1 <- rw_incidence(rw_influenza_fit3_N1, num_days = nrow(df3), time_labels = df3$week)

# Reorder pathogen labels
rw_mod_inc1_N1$pathogen <- factor(rw_mod_inc1_N1$pathogen, levels=c("Influenza A H1N1", "Influenza A H3N2", "Influenza B", "Unknown", "Total"))
rw_mod_inc2_N1$pathogen <- factor(rw_mod_inc2_N1$pathogen, levels=c("Influenza A H1N1", "Influenza A H3N2", "Influenza B", "Unknown", "Total"))
rw_mod_inc3_N1$pathogen <- factor(rw_mod_inc3_N1$pathogen, levels=c("Influenza A H1N1", "Influenza A H3N2", "Influenza B", "Unknown", "Total"))
...
ggplot(rw_mod1)+
  ...
  coord_cartesian(xlim=c(as.Date("2012-01-01")+180, as.Date("2024-01-01")-150))+
  scale_x_date(date_breaks = "1 year", date_labels =  "%Y")+
...
ggsave("Figures/InfluenzaNoise1.png", width=10, height=12)
...
ggsave("Figures/InfluenzaNoise2.png", width=10, height=12)
...
ggsave("Figures/InfluenzaNoise3.png", width=6, height=8)
...
rw_mod_prop1 <- rw_proportion(rw_influenza_fit1, num_days = nrow(df1), time_labels = df1$week)
rw_mod_prop2 <- rw_proportion(rw_influenza_fit2, num_days = nrow(df2), time_labels = df2$week)
rw_mod_prop3 <- rw_proportion(rw_influenza_fit3, num_days = nrow(df3), time_labels = df3$week)
...
rw_mod_prop <- rbind(rw_mod_prop1,
                     rw_mod_prop2,
                     rw_mod_prop3)
...
ggsave("Figures/InfluenzaPP1.png", width=10, height=8)
