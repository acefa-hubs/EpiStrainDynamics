...
authors. Test cases and improvements are especially welcome. This
outlines how to propose a change to `EpiStrainDynamics`. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("acefa-hubs/EpiStrainDynamics", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://acefa-hubs.github.io/EpiStrainDynamics/CODE_OF_CONDUCT.md).
