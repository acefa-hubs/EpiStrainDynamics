...
If you would like to contribute to the package, please review the [contributing guide](https://github.com/acefa-hubs/EpiStrainDynamics/blob/main/.github/CONTRIBUTING.md). 
Test cases and improvements are especially welcome. 
If you see any mistakes in the package you can also let us know by logging a bug on the [issues](https://github.com/acefa-hubs/EpiStrainDynamics/issues) page. 
