...
Detailed instructions can be found on the [vignette](https://docs.ropensci.org/EpiStrainDynamics/articles/Using-EpiStrainDyamics.html).
...
For a more detailed discussion, check out the [vignette](https://docs.ropensci.org/EpiStrainDynamics/articles/Using-EpiStrainDyamics.html).
