...
The `subtyped()` pathogen structure enables additional complexity, specifically for an influenza modelling scenario, by allowing the user to incorporate testing data for influenza A subtypes.
The user specifies columns containing the unsubtyped influenza A case count as well as the subtyped influenza A cases, and any additional pathogens to be modelled.
